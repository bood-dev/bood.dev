            ...
            <div class="project-cards row isotope">
                ...
                <div class="isotope-item col-md-6 mb-5 backend frontend">
                    <div class="card project-card">
                        <div class="row no-gutters">
                            <div class="col-lg-4 card-img-holder">
                                <img src="{{ asset('/images/proyectos/SGSI/home.jpg') }}" class="card-img" alt="image">
                            </div>
                            <div class="col-lg-8">
                                <div class="card-body">
                ...
                <div class="isotope-item col-md-6 mb-5 frontend">
                    <div class="card project-card">
                        <div class="row no-gutters">
                            <div class="col-lg-4 card-img-holder">
                                <img src="{{ asset('/images/proyectos/Asproem/home.png') }}" class="card-img" alt="image">
                            </div>
                            <div class="col-lg-8">
                                <div class="card-body">
                ...
                <div class="isotope-item col-md-6 mb-5 frontend">
                    <div class="card project-card">
                        <div class="row no-gutters">
                            <div class="col-lg-4 card-img-holder">
                                <img src="{{ asset('/images/proyectos/ViveroSanMiguel/home.png') }}" class="card-img" alt="image">
                            </div>
                            <div class="col-lg-8">
                                <div class="card-body">
